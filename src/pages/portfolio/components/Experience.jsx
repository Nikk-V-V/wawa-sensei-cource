...
export default function Experience() {
	...
	const [section, setSction] = useState(config.sections[0]);
	...
	useFrame(() => {
		if (isMobile) {
			screenContainer.current.position.x =
				-scrollData.offset * SECTIONS_DISTANCE * (scrollData.pages - 1);
			screenContainer.current.position.z = 0;
		} else {
			screenContainer.current.position.z =
				-scrollData.offset * SECTIONS_DISTANCE * (scrollData.pages - 1);
			screenContainer.current.position.x = 0;
		}
	...
	return (
		<>
			...
			<motion.group ref={screenContainer} animate={section}>
				{/* HOME */}
				<motion.group
					position-y={-5}
					variants={{
