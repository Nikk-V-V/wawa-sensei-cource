...
export default function ScreenTransition({transition, color}) {
    ...
    useFrame(() => {
        ...
        transitionMaterial.current.uniforms.uProgression.value = MathUtils.lerp(
            ...
            (new Date() - transitionData.current.started) / (TRANSITION_DURATION * 1000)
        )
    })
    ...
    return (
        ...
        <Hud>
            ...
            <mesh>
                <screenTransitionMaterial ref={transitionMaterial} transparent uColor={color} />
